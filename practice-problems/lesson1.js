...
//Answer: Serves as a placeholder to create varible
...
//Answer: Undefined, Null, String


//4. Why do we use comments in JS?

//Answer: Notes to programmer


//5. Why do we use 'strict mode'?

//Answer: Restrict javascript functions that were created by accidents
...
//Answer: For "or" it will determine if at least one side is true or false while and will determine if both sides are true or false
...
//Answer: == means that two things are equal while === is comparing
...
//Answer: 9 used node in the terminal
