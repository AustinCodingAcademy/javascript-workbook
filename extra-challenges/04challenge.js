...
// Associative array (Object) is a type of object that stores values in a key value pair. Dictionaries, Maps, Tables are associatve arrays that can be found in other languages. The key here can be any object such as string, number, or another data-type. The same thing can be applied to value.
// The difference between array and associative-array is that arrays use 0 based integer value as key to store values while associative arrays use any object to store values.
