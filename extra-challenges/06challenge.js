...
//
// point is a simple associative array with values x and y
// anotherPoint is a variable that created using the Point constructor. They have the properties of Point class (inherited). Therefore anotherPoint can be classified as an object created using Point class using it's constructors and may have special methods and properties in future.
...
//
// What is a method?
// Method is a function in a class that can return/set it's properties or do something related to the object.
//
