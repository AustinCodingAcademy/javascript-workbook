...
class TicTacToe extends React.Component {
  ...
  players(event){
    ...
    if (boardGrid[gridNumber] === null){
      ...
      alert = (<div className="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Invalid move!</strong> Please try again.
    ...
    if (winnerArray.some(y => y === true)){
      ...
      alert = (<div className="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Congrats!</strong> You win!
                <button type="button" className="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
              </div>)
    ...
    if (turnCounter === 9){
      alert = (<div className="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Tied Game!</strong> No One Wins!
                <button type="button" className="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
              </div>)
  ...
  render() {
    return (
      <div>
        <div className="row">
          <button type="button" className="btn btn-primary" data-cell="0" onClick={this.players}>{this.state.board[0]}</button>
          <button type="button" className="btn btn-primary" data-cell="1" onClick={this.players}>{this.state.board[1]}</button>
          <button type="button" className="btn btn-primary" data-cell="2" onClick={this.players}>{this.state.board[2]}</button>
        </div>
        <div className="row">
          <button type="button" className="btn btn-primary" data-cell="3" onClick={this.players}>{this.state.board[3]}</button>
          <button type="button" className="btn btn-primary" data-cell="4" onClick={this.players}>{this.state.board[4]}</button>
          <button type="button" className="btn btn-primary" data-cell="5" onClick={this.players}>{this.state.board[5]}</button>
        </div>
        <div className="row">
          <button type="button" className="btn btn-primary" data-cell="6" onClick={this.players}>{this.state.board[6]}</button>
          <button type="button" className="btn btn-primary" data-cell="7" onClick={this.players}>{this.state.board[7]}</button>
          <button type="button" className="btn btn-primary" data-cell="8" onClick={this.players}>{this.state.board[8]}</button>
        </div>
        {this.state.alert}
      </div>
    );
