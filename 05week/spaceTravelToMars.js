...
function Ship(name, type, ability) {
  ...
  this.crew = [];
  this.missionStatement = function() { //vvv This would also work/old method vvv
    const found = this.crew.some((crewMember) => { // var that = this;
      return jobTypes[crewMember.job] === this.type; // ...=== that.type;
    }); // because this gets changed with the new function
    if (found) {
      return this.ability;
    } else {
