  ...
  render() {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'row' },
        React.createElement('div', { 'data-cell': '0', onClick: this.clickHandler }),
        React.createElement('div', { 'data-cell': '1', onClick: this.clickHandler }),
        React.createElement('div', { 'data-cell': '2', onClick: this.clickHandler })
      ),
      React.createElement(
        'div',
        { className: 'row' },
        React.createElement('div', { 'data-cell': '3', onClick: this.clickHandler }),
        React.createElement('div', { 'data-cell': '4', onClick: this.clickHandler }),
        React.createElement('div', { 'data-cell': '5', onClick: this.clickHandler })
      ),
      React.createElement(
        'div',
        { className: 'row' },
        React.createElement('div', { 'data-cell': '6', onClick: this.clickHandler }),
        React.createElement('div', { 'data-cell': '7', onClick: this.clickHandler }),
        React.createElement('div', { 'data-cell': '8', onClick: this.clickHandler })
      )
    );
  }
  makeMove(e) {
  ...
  checkForWin() {
    ...
    for (let i = 0; i < 9; i += 3) {
      if (square[i].innerHTML) {
        if (square[i].innerHTML === square[i + 1].innerHTML && square[i + 1].innerHTML === square[i + 2].innerHTML) {
          alert(square[i].innerHTML + "'s wins!");
        }
      }
    }
    for (let i = 0; i < 4; i++) {
    ...
    if (square[4].innerHTML) {
      ...
      if (square[2].innerHTML === square[4].innerHTML && square[4].innerHTML === square[6].innerHTML) {
        alert(square[4].innerHTML + "'s wins!");
      }
    }
  }
  clickHandler(e) {
