...
class TowersOfHanoi extends React.Component {
  ...
  render () {
    return (
      <div>
        <div data-stack='1' onClick={this.setBlock}>
          <div data-block='100' onClick={this.removeBlock}></div>
          <div data-block='75' onClick={this.removeBlock}></div>
          <div data-block='50' onClick={this.removeBlock}></div>
          <div data-block='25' onClick={this.removeBlock}></div>
        </div>
        <div data-stack='2' onClick={this.setBlock}>
        </div>
        <div data-stack='3' onClick={this.setBlock}>
        </div>
      </div>
    );
  }
