...
// .remove should also take one argument, car. look for the index of the car in this.cars.
// If it is found, splice it out of this.cars. If it isn't found, return "That car isn't here!"
