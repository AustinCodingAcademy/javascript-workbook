...
function returnTrue(5 === 5) {
  // should return true

}

function returnFalse(5 >= 9) {
  // should return false

}

function greaterThan(big, small 12 >= 9) {
...
function lessThan(small, big 9 >= 12) {
