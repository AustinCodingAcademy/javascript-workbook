...
//it will only be one of these 2 words
function Checker(color) {
    ...
    //but I can't just set the property outright
    //if the color is set to white: String.fromCharCode(0x125CB)
    //if the color is set to black: String.fromCharCode(0x125CF)
}

function Board() {
    //create a property called this.checkers and assign it an empty array
    this.checkers = [];
    //create a method called this.createCheckers. In it, let's define our starting positions of the checkers on the grid.
    ...
    this.killChecker = function(position) {
        ...
        var randomvariablename = this.checkers.indexOf(checker);
        this.checkers.splice(randomvariablename, 1);
