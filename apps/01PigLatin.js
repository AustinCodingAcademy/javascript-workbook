...
Please explain why we are using String.prototype.toLowerCase() here.
  ...
  Your Answer:
    It's to "scrub" the input only for lowercase values.
...
What is the significance of setting vowelIndex to -1?
  ...
  Your Answer:
    When the app runs, it searches the string value starting from 'fromIndex.' It returns -1 if no value is found.
      I.E.
        In this instance if there are no vowels.
*/
...
/* Concept Check
  ...
  Your Answer:
    It's to slice off part of the string then to reattach it after the rest of the string. The vowelIndex determines where to slice the string -- in this case, at the first vowel.
...
Your Answer:
  It prompts the user for specific input.
