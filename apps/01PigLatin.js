...
function pigLatin(word) {
  ...
  //
  // Your Answer:
  //We are using the lowercase command in order to make our output look right.
  // If we didn't and we had a user input 'Spear' than the program would return
  // 'earSpay'. That doesn't look good and it is kind of confusing.
  ...
  //
  // Your Answer:
  //We are setting our code to assume there are no vowels.
  ...
  //
  // Your Answer: We are using the slice to slice the word. We need the vowelIndex
  // to know where to slice the word.
...
//
// Your Answer: It provides a prompt to the user. In this case it spits out
//'word:__'.
function getPrompt() {
