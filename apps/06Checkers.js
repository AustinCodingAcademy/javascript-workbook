...
[6, 1], [6, 3], [6, 5], [6, 7], [7, 0], [7, 2], [7, 4], [7, 6]];
        for (var i = 0; i < whitePositions.length; i++) {
            var whiteCoordinates = whitePositions[i];
            this.grid[whiteCoordinates[0][whiteCoordinates[1]]] = new Checker("white")
        }

        for (var j = 0; j < blackPositions.length; j++) {
            var blackCoordinates = blackPositions[i];
            this.grid[blackCoordinates[0][blackCoordinates[1]]] = new Checker("black")
        }
