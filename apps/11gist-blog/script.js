...
//the "content" of the file. Next look for a "comments_url". At that address, you'll see a collection of comments, with keys such as "user" and "body".
//Spec 1.1
...
//Spec 2
//After the links are are inserted, add a click listener, and prevent the default event from occuring. Then make an ajax call with the
//"data-url" value, grabbing it with $.data('url').
//Spec 3
//Insert the "content" of the file named post.md into #post.

//Spec 3.1
//Since our "content" is written in Markdown, we can use the Marked.js library to convert the content to html. Simply call marked()
//on your content. e.g. marked(content).
//Spec 4
//After inserting your content, make another ajax call using the "comments_url", and insert the ["user"]["login"] and "body" in a list
//in #comments.
//similar to TODO app
//Spec 5
...
//you should only have to change one url: http://127.0.0.1:8080/apps/11gist-blog/api/gists.json to https://api.github.com/users/<your github username>/gists.
