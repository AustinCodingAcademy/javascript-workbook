// length
let cars = ["ford", "chevy", "vauxhall", "toyota"];
console.log(cars.length);
//get 4 as result

// concat
let moreCars = ["kia", "hyundai", "porsche", "honda"];
...
//slice
let removedCars = carsInReverse.slice(1, 7);
console.log(removedCars);
//this let references the sorted string above--removed chevy and vauxhall, returned row of [ 'ford', 'honda', 'hyundai', 'kia', 'porsche', 'toyota' ]


// splice
let removed = carsInReverse.splice(1, 2, "ford", "honda");
console.log(carsInReverse);
...
//shift
let shifted = carsInReverse.shift(0);
console.log(shifted);
...
function addToNewArray (element) {
