...
// It is an array that has properties associated with it. i.e Person can have an array
// of First name and last name and the properties would be the actual names. The difference is that
// arrays use numbered [0] indexes, and objects or associate arrays use named indexes [firstname] = Gabe
