...
//
//
//  Arrays are variables that hold more than one value. Each value is given a specific index starting from 0
// and can be accesed by refering to that index.
// An associative array, or object, is an variable that holds more than one value.
// Associative arrays are different from standard arrays in that they use a key: value pairing instead of indices.
// See examples below for more detail:
// Ex 1 - Array
// var myArr = ['chris', 2, true, null]
// myArr[0] // -- 'chris'
// myArr[1] // -- 2
// myArr[2] // -- true
// myArr[3] // -- null
...
// Ex 2 -  Associate Array
 ...
 // };
 //  myDetails; => Object {
 // name: Object { firstName: 'Chris', lastName: 'Jimenez' },
 // age: 34,
 //  city: 'san marcos' }
