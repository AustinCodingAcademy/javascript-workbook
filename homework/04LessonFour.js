...
var shiftedBravestWarriors = bravestWarriors.shift();

var popedBravestWarrior = bravestWarriors.pop();

console.log(shiftedBravestWarriors);

console.log(popedBravestWarrior);
