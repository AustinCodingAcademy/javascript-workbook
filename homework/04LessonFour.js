...
// an array is a list of items, they can be numbers & strings. I believe //     a boolean can be as well but I'm not 100% certain on that.
              // var arrOne = [4, 6, 'Hola, Travis!']
...
describe('Lesson 4 Homework', function () {
  ...
  describe('Popular Array Methods', function () {
    ...
    describe('Problem 4: numberArray after unshift(0)', function () {
      it('should be the same array with zero added at the begining', function () {
