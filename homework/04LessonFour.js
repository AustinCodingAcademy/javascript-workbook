...
var bravestWarriors = ['Impossibear', 'Danny', 'Chris', 'Beth', 'Wallow', 'Catbug']
bravestWarriors.pop();
...
//another way to store information when coding.
//both are collections of data. Arrays have an implicit index starting from 0 and assoicative arrays have an //explicit index called a key with an associated value.
//
