...
//Associative arrays are dynamic objects that the user defines as needed. Instead of using a number as the index, you can use 
//use anything that you want as the index with associative arrays making code much more clear.
