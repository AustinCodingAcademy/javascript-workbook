...
//Associative arrays (objects) use an explicit index called a key with an associated value. The key can be whatever you want. An array uses an implicit index starting at 0.
//
