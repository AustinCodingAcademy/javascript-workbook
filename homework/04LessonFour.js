...
//Associative Arrays (objects) have a similar structure to normal Arrays, but objects are based around their indexing of 0,1,2,3, etc. whereas objects use keys which are defined by the person writing the code.
//
