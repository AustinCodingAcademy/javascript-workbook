...
// ['Danny', 'Chris', 'Beth', 'Wallow']-Use Pop and SHIFT
...
//An associative array is also referred to as an Object. It is very similar to an array because it too is a collection of data.
//There are a handful of significant differences in how the two are organized. For one, arrays have an implicit index starting from 0.
//Associative arrays have an explicit 'index' called a key, with an associated value.
