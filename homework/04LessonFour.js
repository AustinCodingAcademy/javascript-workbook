...
//      An associative array is the same as an object, where the index is explicit (uses a key:value pairing). A normal array is implicitly indexed according to the order of the values within the array.
//
