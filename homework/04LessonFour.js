...
// An object (associate array) is a collection of data that is stored in properties. A property is made up of a key and a value.  For example, a key of city could have the value of 'Austin'.  The main difference between an array an an associate array (object) is how the data is stored.  An array uses a 0-index while an object uses properties made up of keys & values.
//
