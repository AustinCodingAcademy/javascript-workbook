...
console.log(bravestWarriors.shift());
console.log(bravestWarriors.pop());
...
console.log(problemNineObject['fav food']= 'tacos');
console.log(problemNineObject['city']= 'austin');
...
console.log(nestedObjects.users['bob roberts'].starring ='Tim Robbins');
...
//
// Your Answer Goes Here: associative array, also called an object basically lets us define our own data in other words lets us have a completely customized array. An array has only one data type, its a little preset by the user before hand.
//
//
