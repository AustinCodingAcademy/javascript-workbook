...
//    Scope refers to the area of availability for a variable or function. Global variables (defined outside of a function) have more scope than local variables (variables declared within functions).
//
...
//
// Your Answer Goes Here:
//         It acts as a conditional switch between two values; true becomes false, 0 becomes 1, 'on' becomes 'off', etc. It can switch between any two values or states.
//
...
var lengthFiveArray = ['hello', 'there', 'nugget', 'and', 'bugsy'];
