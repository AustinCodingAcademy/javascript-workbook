...
// An item's scope refers to where exactly it is accessible from. There are two types of scope in Javascript. Global Scope : Global is nothing but a window level scope.Here, variable present throughout the application. Functional Scope : Variable declared within a function with var keyword has functional scope.
//
...
//
// Your Answer Goes Here:
// The conditional (ternary) operator is the only JavaScript operator that takes three operands and is frequently used as a shortcut for the if statement. It looks like this... condition ? expr1 : expr2
...
var lengthFiveArray  = [8, 'steve', false,'friend', 0]
