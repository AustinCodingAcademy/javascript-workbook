...
// What is scope?
//
// Your Answer Goes Here:An item's scope refers to where exactly it is accessible from.
//
//
// ****
// Ternary Operator
...
//
// Your Answer Goes Here:'?' -- ternary operator helps shrink the code and serves the same purpose as a 'if' statement. Its different because it can execute the whole condition on the same line.
//
//
...
threeByThreeArray[1,1]=99;
// Problem 12:
// create a 2 by 2 (2 rows, 2 columns) nested array
var twoByTwoArray=[[0,0],[1,1]];
