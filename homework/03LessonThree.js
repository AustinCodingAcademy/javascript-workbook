...
// scope refers to where the item is accessible from - either global (accessible anywhere) or local (only accessible within a function).
//
...
//
// Your Answer Goes Here:
//  the ternary operator is a quick way to return results based on a value being true or false without using if statements.  It's syntax is shorter than an if statement.
//
