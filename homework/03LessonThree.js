...
//Scope is the set of variables you have access to (can be local-only accesed wihtin function or global-scripts and functions can access it.)
//
...
var newArray = nameArray.splice(1,1, 'george')
