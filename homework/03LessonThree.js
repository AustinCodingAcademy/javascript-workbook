...
// What is scope?
//
// Your Answer Goes Here: scope is the set of variables, objects, and functions you have access to
//
//
...
//
// Your Answer Goes Here: a conditional operator that assigns a value to a variable based on some condition.
// it differs in that it is used to make the code more condensed or shortened.
//
...
var lengthFiveArray = ['one', 2, 'three', 4, 'five'];
...
threeByThreeArray[1][1] = 'Charmander'
