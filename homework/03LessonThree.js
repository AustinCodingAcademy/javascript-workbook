...
// Scope refers to where a variable is accessible from.
//
...
//
// Your Answer Goes Here:
// The ternary operator is used when a function can be toggled "on" or "off" to help shrink the syntax. The pattern is condition ? expr1 : expr2.
//
