...
// What is scope?
//
// Your Answer Goes Here: Scope is where exactly an item is accessible from.
//
//
...
//
// Your Answer Goes Here: In computer science, a ternary operator is an operator that takes three arguments. The arguments and result can be of different types. This operator is frequently used as a shortcut for the if statement.
//
//
...
var lengthFiveArray = ['steve', 'ernie', 'joe', 'austin', 'matt'];
