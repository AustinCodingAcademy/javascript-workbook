...
// Scope is a range in which a specific variable/function applies
//
...
// 
// Your Answer Goes Here:
//It is to examine the truthiness of a statement, and return values according to its truthiness; it is more concise and efficient. 
//
...
var lengthFiveArray = ['John', 'Luke', 'Mark', 'Matthew', 'Paul'];
...
// Replace the center element of threeByThreeArray, which is 5, with something else.
  threeByThreeArray[1][1] = 21;
// Problem 12:
// create a 2 by 2 (2 rows, 2 columns) nested array
var twoByTwoArray = [[0,1],[0,1]];
// ****
// Tests
