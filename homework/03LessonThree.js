...
//
// Your Answer Goes Here: it takes something and checks to see if it is true and if it is it does one thing otherwise it does something else. Similar to if else statements, but only written in a single line and only takes an if and an else
//
//
...
var lengthFiveArray = [true, 1, "two", 3, ["one", false, 3]];
...
threeByThreeArray[1,1] = false;

// Problem 12:
// create a 2 by 2 (2 rows, 2 columns) nested array
var twoByTwoArray = [[0.0, 0.1], [1.0, 1.1]];
