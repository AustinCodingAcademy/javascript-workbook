...
// What is scope?
//
// Your Answer Goes Here: An item's scope refers to where exactly the JavaScript gremlin can access it.
//
//
...
//
// Your Answer Goes Here: A ternary operator is used as a switch to toggle an object between two states. It differs from a conditional statement by shrinking its syntactical footprint and should generally be used when evaluating a Boolean value and taking one action if true and another if false.
//
//
...
threeByThreeArray[1][1] = 'butts';

// Problem 12:
// create a 2 by 2 (2 rows, 2 columns) nested array
var twoByTwoArray = [['butts', 'boobs'], ['poop', 'barf']];
