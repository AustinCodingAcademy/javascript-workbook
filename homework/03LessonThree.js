...
// Scope refers to where a variable name is relevant, be it in the main set of code or within a function.
// Variables referred to outside of scope will result in an error
