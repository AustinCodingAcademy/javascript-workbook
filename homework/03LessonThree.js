...
// Scope is the context in which a variable or function can be used. For instance, a variable created in a function can only be used in that function, its scope does not include anything beyond that function
//
...
//
// Your Answer Goes Here:
// The ternary operator allows you to evaluate a boolean statement and provide two values, one to be returned if the statement is true, and one to be returned if the statement is false. This is also much easier than using "if" statements because it only takes one line.
//
...
var index = nameArray.indexOf("fred");
nameArray[index] = "george";
