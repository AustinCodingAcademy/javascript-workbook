...
//scope is the extent to which you can access variables
//
...
//
// Your Answer Goes Here:
// ternary operator accepts 3 operands, if the first operand evaluates as true it returns the value of the second operands, if its false, it returns the value of the third operand
//
...
var lengthFiveArray=new Array(5);
...
var twoByTwoArray = new Array(2);
twoByTwoArray[0] = new Array(2);
twoByTwoArray[1] = new Array(2);
