...
$(document).on('ready', function() {
  ...
  var $textToChange = $('#insert-text');
  $textToChange.text('Text Has Been Inserted')

  // Problem 10:
  // select the element with id="add-attribute"
  // add the attribute data-color="red" to that element
  var $theElement = $('#add-attribute');
  $theElement.attr('data-color','red')
  ...
  window.dataIdValue = div.data('id');
