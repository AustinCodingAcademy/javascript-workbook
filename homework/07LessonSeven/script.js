...
$(document).on('ready', function() {
  ...
  window.dataIdValue=$("#insert-text");
  window.dataIdValue.text('Text Has Been Inserted');

  // Problem 10:
  // select the element with id="add-attribute"
  // add the attribute data-color="red" to that element
window.dataIdValue=$("#add-attribute");
window.dataIdValue.attr('[data-color]');
window.dataIdValue.attr('data-color', 'red');
