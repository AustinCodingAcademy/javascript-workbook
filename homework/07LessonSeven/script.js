...
$(document).on('ready', function() {
  ...
  window.addAttribute[0].setAttribute("data-color", "red");
  ...
  var divToSelect = $("#data-element");
  var contentToSelect = divToSelect.data("content");
  $("#data-element").text(contentToSelect);
});
