...
//
// An array is used to store multiple values in a single variable (this is point).  An object has characteristics and can be considered part of a class (this is anotherPoint).  These are both basically the same, since the array is essentially an object in js.
// The difference between point and anotherPoint is that they have different (x, y) values.
//
...
// What is a method?
//
// A method is a object property that contains a function definition.
//
