...
// A point is a class, that other objects can be formed from, with the same 'properties' but with different values. 
// A point object that is constructed from the Point class, is something that is made with the 'shell' of the originating class, but with different property values.
//
...
//
// What is a method?
// A method is another word for action that an object can preform.
//
