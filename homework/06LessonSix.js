...
//An object literal is a framework for creating other objects depending on
// what is passed into the code. 'anotherPoint' is an example of one thing that was
// able to be created because of the code we created by using an object literal
// (Point). Object literals are the containers that has compartments that must be
// filled. It's a process of creating those containers.
//
...
//
// What is a method?
//A method is a reusable function that can be applied to Objects and object literals
// in order to make it easier to run functions within and between Objects.
