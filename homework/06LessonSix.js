...
function AnotherPoint(someX, someY) {
  this.x = someX;
  this.y = someY;
}

var anotherPoint = new AnotherPoint(5, -3);
...
//
// The values in Point are "hard-coded" into the object, whereas the values of
// AnotherPoint will be passed in as arguements when the class of AnotherPoint
// is instantiated.
...
// What is a method?
//
// A method is a function that operates on an object; methods have access to
// the scope of their enclosing Class, unlike normal/other functions.
