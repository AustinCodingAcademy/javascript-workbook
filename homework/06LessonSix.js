...
//Point is the class. There is not a physical example of the point but it it jsut setting the list of charastics. anotherPoint is creating a new point with actual values.
//
...
//
// What is a method?
//Method is a piece of code that can be called by name that is associated with the object that is created. 
//
