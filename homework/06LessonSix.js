...
//  The class constructor is like blueprints, it can print a bunch of differnt objects based on the different attributes passed to it.  The point class is statically constructed (it can be changed later), but only one of it exists at any given time.
//
...
function Person(name) {
  this.name = name;
  this.sayHi = function() { return ("Hi, I'm " +this.name + '!');};
}
...
//
// What is a method?
//a function that is a property of and ranby an object
//
