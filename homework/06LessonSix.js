...
// point was not constructed using an object constructor, when its attributes were declared they were declared as specific variables within the object
//When anotherPoint was constructed through Point(x,y) it can be passed information using the constructor instead of being made in place
//this allows you to use something like a for loop to construct many objects quickly, a literal cannot be built this way
//it also makes use of the this.attribute function to assign the attribute to the cosntructed object
//
...
//
// What is a method?
//A method is a way of using a function that utilizes the strict context of the object called which posesses the method.
//Methods can access data inside the object
//
