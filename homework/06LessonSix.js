...
// point has set properties, where as anotherPoint was created and can be easily altered due to it's contructor class, Point.
//
...
var conferenceRoom = new ConferenceRoom(jen);
...
//
// What is a method?
// A method is a function that a class already knows. So, we've created a new person, jen. A method within jen is sayHi. If we call sayHi on Jen, she already knows to say "Hi, I'm Jen!"
//
