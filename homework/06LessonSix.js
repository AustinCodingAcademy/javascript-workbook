...
// and anotherPoint (a point object constructed from the Point class)? Other than how they are created there isn't much difference unless we want to start adding methods or creating multiple points. Creating objects from the Point class would make it much easier to create numerous points. Regarding methods, using the Point class is beneficial in that each object would share the same method rather than having individual (probably identical) methods for each object taking up memory.
//
//
...
// Write your answer in comments
//
// What is a method? A property of an object that contains a function definition.
//
//
