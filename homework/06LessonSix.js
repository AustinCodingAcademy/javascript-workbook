...
//
// "point" defines a class and the properties that are associated with it. "anotherPoint" is a variable that creates a new object 
// using the properties already defined in the "point" class.
