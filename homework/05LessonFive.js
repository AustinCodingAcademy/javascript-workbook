...
three+=3;
var threePlusAssignmentThree = three; //6

// Problem 4:
// What is the result of four -= 3?
four -=3;
var fourMinusAssignmentThree = four; //1

// Problem 5:
// What is the result of five *= 2?
five *=2;
var fiveMultiplicationAssignmentTwo = five; //10

// Problem 6:
// What is the result of six /= 3?
six /=3;
var sixDivisionAssignmentThree = six; //2
...
//  this is a way to continue to do something until true/false or equals something that passese the logic test
//  via While you can do until true/false
//  For loops are the same thing with a fixed/finite number of moves
