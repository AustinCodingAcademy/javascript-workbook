...
// Loops are iterative processes that run for a specified period.  Usually, this means that the iterative process runs while a certain condition is true.
// The process will repeat, or iterate, each coded task until it's condition becomes falsey.
