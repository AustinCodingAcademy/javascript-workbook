...
//  loops are functions that all us to repeat/iterate over the same bit of code while the condition exists.  They are use because they are way to not have write the same code multiple times.
