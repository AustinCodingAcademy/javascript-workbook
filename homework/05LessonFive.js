...
//    Loops are chunks of code that are to be executed a certain number of times. We use a FOR loop when we know how many times we want the code to execute and we use a WHILE loop when we don't know how many times we want it to execute, but we set up a condition to eventually break the loop. 
