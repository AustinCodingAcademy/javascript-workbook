...
// loops come in a few varients, while loop, for loop and do while loop . we use them to 
// quickly permutate through a set a repetitive tasks which would otherwise take each case
// its own test or check. 
