...
//
// What are loops? Why do we use them? Loops are a block of code that runs the same code over a number of times. We use them to avoid having to repeat code when we need a slightly different result in a pattern.
//
