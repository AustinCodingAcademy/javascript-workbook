...
// Answer: loops like overachieving if statements. Instead of running a block of code once if a condition is true, a loop will run it over and over again as long as the condition is true. We use loops to minimize code for repetitive tasks as well as to deal with situations where we can't know all the facts until the code is being run.
