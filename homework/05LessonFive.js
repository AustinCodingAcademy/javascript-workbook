...
// Loops are used to cycle through an array to perform a series of operations on each element in the array, or until the JS Gremlin is told (by rules the user sets up) to stop executing the code within the loop.
