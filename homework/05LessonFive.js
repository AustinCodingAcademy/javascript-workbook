...
var twoMinusMinus = --two;

// Problem 3:
// What is the result of three += 3?
var threePlusAssignmentThree = three+= 3;

// Problem 4:
// What is the result of four -= 3?
var fourMinusAssignmentThree = four-= 3;

// Problem 5:
// What is the result of five *= 2?
var fiveMultiplicationAssignmentTwo = five *= 2;

// Problem 6:
// What is the result of six /= 3?
var sixDivisionAssignmentThree = six /= 3;
...
// Loops are used if you want to run the same code over and over again. Loops run the same block of code depending on certain params you set, a for loop for example includes 3 parts:  where you start, how long the code will run so long as this part is true, and by how many increments.
