...
// Loops execute a line of code whatever times you set it to, which makes the code more
// efficent and less space. Saving space, saves memory, and saving memory reduces load time of a page.
