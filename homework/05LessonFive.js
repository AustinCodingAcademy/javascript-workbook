...
var whileLoopCounterResult = 0;
while (whileLoopCounterResult < 10) {
  whileLoopArrayResult.push(whileLoopCounterResult);
  whileLoopCounterResult++;
}
...
var forLoopCounterResult;
for (forLoopCounterResult = 0; forLoopCounterResult > -10; forLoopCounterResult--) {
  forLoopArrayResult.push(forLoopCounterResult);
}
