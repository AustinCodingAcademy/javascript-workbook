...
//Loops are where we can code statements that set beginning, set an end,
// and set an increment to be either added or subtracted from the beginning
// number (or string).
// Loops are ways to save keystrokes when writing code.
// ****
// Tests
