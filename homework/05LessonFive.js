...
// Loops are used to execute a block of code multiple times. They're handy if you need to run 
// the same code over and over again, but each time with a different value. 
// ****
// Tests
