...
// ANSWER: A loop is code written to perform a repetitive task when you know how many times you want to repeat the task.  We use them so we don't have to write lengthy code or do repetive tasks.
