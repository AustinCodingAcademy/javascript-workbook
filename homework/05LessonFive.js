...
// Loops are pieces of code that can be utilized to continue a function until the desired values are achieved.
// Loops can be implemented in place of redundant code to replace functions that repeat the same process with different variables.
