...
//A set of statements meant to repeat a set of times determined by the conditional part of the 'loop' statement is called a loop.
// we use loops to avoid retyping the same code over and over again.
