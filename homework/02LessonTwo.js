...
// A function is an operation of one or more javascript statements that are performed on one or more arguments, returning a value.
//
// They are defined/written thusly:
...
//
// Your Answer Goes Here:
// A return value is essentially the answer that is spit out by the execution of a function.
//
// How do you define a named function?
//
// Your Answer Goes Here:
// var namedFunction = function (parameter1, parameter2) {
//  expression here;
// }
//
...
//
// Your Answer Goes Here:
// They are really similar, but technically a parameter is a variable that is to be evaluated by a function, whereas an argument is the actual data/value that is evaluated by the function.
// ****
...
//
// Your Answer Goes Here:
// Conditionals are used to evaluate the relationship between two values, to determine if certain conditions are met by the relationship between those values.
//
// ****
