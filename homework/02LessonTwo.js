...
//
// Your Answer Goes Here: A JavScript function is code written to perform a certain task. You define a JavaScript by using the word "function" and giving it a (custom) name -- followed by a task to perform in (parentheses).
//
//
// What is a return value?
//
// Your Answer Goes Here: A return value is the result of the function displayed back to the person who called/executed the function.
//
//
// How do you define a named function?
//
// Your Answer Goes Here: You store it within an expression.
//
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here: Paramaters are the names listed in the function definition. Arguments are the real values in the function. Yes, essentially, parameters are placeholders for arguments.
//
// ****
...
//
// Your Answer Goes Here: Conditionals (e.g., if, else, if else) are used to make different actions happen based on different conditions. 
//
//
// ****
