...
//  a value that you want to return when the function is called & completed.
// Your Answer Goes Here:
// a value that you want to return when the function is called & completed.
//
...
//
// Your Answer Goes Here:
//  It gives a function a name that can be recalled vs anonymous function that are needed for a purpose and less reuse
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here:
//  Parameter is what you send the function.  Arguments are the actual values assigned to the parameters
// ****
