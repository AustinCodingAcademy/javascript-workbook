...
//  A function is sub program that is designed to make something happen depending on the code. to define a function you label it a function which is a key word.
//
// What is a return value?
//
// Your Answer Goes Here:
//  A return value is when the function takes the arguments and places them in the peramiters and what the output of the function is.
//
// How do you define a named function?
//
// Your Answer Goes Here:
//It binds a name to the function so you can call the function by its name within the scope.
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here:
//Parameters are the names listed in the function ie function(beef, pork). Arguments are the values massed to the parameter ie beef = ribeye pork = bacon. Yes a parameter is set in the function and the argument is the changable value applied to it.
// ****
