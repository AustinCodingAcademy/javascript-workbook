...
//a function is a block of code designed to execute a particular task.  you define a function by starting with the keyword "function" followed by a name, followed by parentheses ()
//
//
...
//
// Your Answer Goes Here:
//you define a function by starting with the keyword "function" followed by a name, followed by parentheses ()
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here:
//A parameter is like the placeholder for the values used in the function.  an argument is the actual numbers used when calling the function.  they are similar, but parameter is more generic.
// ****
...
function testNumber(number) {
  if(number % 4 === 0) {
    ...
    return 'not divisible by 2, 3, 4, or 5.  try a different number';
  }
}
...
//
// Your Answer Goes Here:
// conditionals allow you to compare values or expressions and return different results depending on the situation.
//
// ****
