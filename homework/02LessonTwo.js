...
// A function takes one or more arguments to be manipulated and then manipulates them according to a set of statements.
// There are different ways to declare functions - in this lesson I am using a function expression:
...
//
// Your Answer Goes Here:
// When a function produces a value, a return statement can be used to determine the value the function returns -
// it immediately jumps out of the current function and returns the return value to the code that called the function.
//
// How do you define a named function?
//
// Your Answer Goes Here:
// To define a named function (using a function expression) the function is written as:
// function [functionName](param1, param2)  {
//  (do something with the parameters here)
//  }
//
...
//
// Your Answer Goes Here:
// Yes, there is a difference. A parameter is a variable input given in the declaration of a function, whereas an argument is the actual value of this variable that gets passed to the function.
// A parameter, then, is a designated place in a function where arguments can be given and passed to the function when it is called at runtime.
// ****
...
// Your Answer Goes Here:
//
// Conditional statements take a set of given parameters that define
// a set of conditions to be met,
// and then perform actions on arguments that match those parameters.
// Conditionals can also be made to perform actions on arguments that do NOT
// match these given parameters.
// ****
