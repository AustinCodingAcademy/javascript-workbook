...
//
// Your Answer Goes Here: A function performs an action, you define a function in Javascript by using this syntax "function () { code here that does something; }"
//
//
// What is a return value?
//
// Your Answer Goes Here: The return value evaluates the function and gives you the "answer", which can be a boolean value/a string/a number.
//
//
// How do you define a named function?
//
// Your Answer Goes Here: Define a names function by placing the name after the word function, function INSERTNAMEFUNCTION () {}.
//
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here: An argument is the actual value that is passed to the function. Parameter refers to the variables that are used in the function to represent those arguments.
//
// ****
...
//
// Your Answer Goes Here: Conditionals are essential in the logic of programming. if something then, do this, else do something else, unless if something else is true.
//
//
// ****
