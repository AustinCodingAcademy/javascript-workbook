...
// A function is a section of code that performs a task. It helps break the large solution into smaller solutions.  When you put function infront of something then declares that it is a function.
//
// What is a return value?
//
// Your Answer Goes Here:
// Return value is what you want it to return after the function is run.
//
// How do you define a named function?
//
// Your Answer Goes Here:
//You define it by writing function nameOfFunction (parameters){code you want it to do}. Or you can have a variable with a function which would be wrote by var name = function (parameters)
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here:
// A parameter is what is going to be tested in the function. An argument is the actual value that is passed through the function. For instance x + y  x=2 y=3 x, y, and z are parameters (the whats going to be used in the function) 2 and 3 are the arguments- the actual values that "replace" the parameters.
// ****
