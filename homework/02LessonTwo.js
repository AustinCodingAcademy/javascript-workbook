...
//
// Functions help us to break up our large problems into smaller, solvable problems
//function addThree(some variables or other functions)
//
// What is a return value?
//
// return is the way out of the function. 
//
//
// How do you define a named function?
//
// function namedFunction(variables and/or other functions.)
//
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// the parameter is the variable that is being tested by the argument.  the argument 
//is the ccomputation or comparison that is performed on the parameters.
//
// ****
...
//
// Conditionals are operators that compare variables in boolean expressions.
//
//
// ****
