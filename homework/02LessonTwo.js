...
//// A function is a named section of code wherein is contained a set of instructions. These instructions are not performed until the function is invoked by calling it in a program.
//You define a function by writing the "function" keyword and then the name of the funtion followed by the arguments (information to be passed in) of the function, within parentheses and separated by commas.
//
// What is a return value?
//
// Your Answer Goes Here:
//A return value is a value that is passed back to whichever scope or function called the function which returned the value.
//A return value signifies the termination of the function which created it and a "return" to whatever space invoked it
// How do you define a named function?
//
// Your Answer Goes Here:
//A named function can be defined by writing "function" followed by a space then name of the function, then any arguments to be passed into the function within parentheses and separated by commas, followed by all instructions for the function enclosed in curly brackets
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here:
//I guess I've already explained up there, but how could any of us have known,
//Parameters are types of information that a function requires to run, they are passed into the function as "arguments"
//Arguments is the information relayed into the function, arguments are the actual data passed in, whether that data is correct in type or incorrect
// ****
...
//
// Your Answer Goes Here:
//Conditionals must evaluate some expression or object and compare its value by or with something or things and then based on that evaluation must do a specified thing, or must do some other thing if it does not recognize the evaluation.
//
// ****
