...
//A function is a building block in JavaScript that peforms a task or calculates a value. You define a function by writing 
//function functionName (parameters) {}
//
// What is a return value?
//
// Your Answer Goes Here:
// It is a statement that stops the execution of a function and returns a value.
//
...
//  function functionName (parameters) {}
// Then you call it by its name, in this case functionName(parameters);, and input any applicable parameters.
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here:
//  Parameters are values that might be used to execute a function. They go inside the parenthesis of a function.
// ****
...
//
// Your Answer Goes Here:
// Conditionals are usually use for comparison. They use boolean variables to evaluate expressions.
// They either compare if one value is equal or not equal, greater than or less than another value.
//
// ****
