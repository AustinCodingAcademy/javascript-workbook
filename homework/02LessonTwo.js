...
//       A function is a chunk of executable code that runs whenever it is called upon.   Either var x = function(a,b){} or just function x(a,b){}
//
// What is a return value?
//
// Your Answer Goes Here:
//       The output value of a function that is returned to the caller; ends the function.
//
// How do you define a named function?
//
// Your Answer Goes Here:   function abc(){}
//
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here: Though they are often used synonymously, there is a slight difference. A parameter is a variable in the declaration of a method/function/procedure. An argument is the actual value of that variable supplied at run-time.
//
// ****
...
//
// Your Answer Goes Here:
//   Conditionals are code blocks that are only executed when the conditions or circumstances specified within the code are met.
//
// ****
