...
function addThree() {
    ...
    // A function is a block of code designed to run a certain task. A function is defined by function , a name and //parentheses
    //
    // What is a return value?
    //
    // Your Answer Goes Here:
    // The return value stops the execution of the function and returns the value from that function.
    //
    // How do you define a named function?
    //
    // Your Answer Goes Here:
    // Function then the name then the execution parentheses then use your open bracket to add your function
    //
    // What is a parameter? What is an argument? Is there a difference between the two?
    //
    // Your Answer Goes Here:
    //
    // Parameters are basically place holders for your arguments while arguments are the actual values.
    ...
    function isEven(number) {
        ...
        //
        // Your Answer Goes Here:
        // Conditionals comapre a undefined value to the function to see if the fucntion is true. if it is not true it tells // the function that it needs to do something "else"
        //
        // ****
