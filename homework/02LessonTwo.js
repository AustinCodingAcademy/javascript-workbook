...
// A function is a block of code to perform a particular task, it can include sometimes parameters and return value.
//
// What is a return value?
//
// Your Answer Goes Here:
// Return value is the result value of the function, It is "returned" back to the "caller"
//
// How do you define a named function?
//
// Your Answer Goes Here:
// A Function names can contain letters, digits, underscores, and dollar signs  as variables names
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here:
// Parameters are the names listed in the function definition, Arguments are the values received by the function when it is invoked.
// The difference between the two is that arguments are the values passing to the function and parameters keep this values.
// ****
...
//
// Your Answer Goes Here:
// conditionals are one of the most important comands becouse you can evaluate a sentenses and take a desicion
//
// ****
