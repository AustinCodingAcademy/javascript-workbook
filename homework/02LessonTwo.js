...
//
// Your Answer Goes Here: A function is a sequence of statements that can receive and return values
//
//
// What is a return value?
//
// Your Answer Goes Here: A return value is the value the function produces
//
//
// How do you define a named function?
//
// Your Answer Goes Here: There are two ways to define a named function:
// 1) Use the keyword 'function' followed by the desired name. ex: function example() 
// 2) Create a variable that has the value of a function. ex: var example = function()
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here: An argument is the actual value passed to the function. A parameter is simply a represenation of the
// arguement.
//
// ****
...
//
// Your Answer Goes Here: Conditionals define a specific condition for the values in question and then return the 
// desired result if the conditions are met.
//
//
// ****
