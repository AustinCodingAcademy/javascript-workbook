...
function lessThanOrEqualTo(paramater1, paramater2) {
    if (paramater1 <= paramater2) {
        return true;
    }
    return false;
...
//A function help us to break up our large problems into smaller, solvable problems.
//You define a finction as below:
...
//
// Your Answer Goes Here:
//A return value just declares what you want to be returned from the function.
//
...
//
// Your Answer Goes Here:
//Conditionals are basically if/then statements. If the function fits one condition, one answer is spit out. If it fits another condition, another statement is spit out.
//
// ****
