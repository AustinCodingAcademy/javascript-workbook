...
//A function is a defined set of actions that will run to solve a given problem or perform a given task on a set of parameters. It's tool which serves whatever "function" you assign to it, for use whenever your program needs it
//
// What is a return value?
//
// Your Answer Goes Here:
// A return value is the value which is *returned* after you declare a return statement
//
// How do you define a named function?
//
// Your Answer Goes Here:
//A named function is a function which you assign a keyword, to call for later use. Such as add() which was used in a previous question. Once we have created and defined add() we can use it again later in our program.
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here:
//Parameters and arguments are different names for the same thing, the items inside of the parenthesis in a function, like add(number1, number2). They are parameters when they are just the placeholders, and arguments once we assign them some value (like 5 or 7).
// ****
...
//
// Your Answer Goes Here:
//Conditionals are elements of a function which can dictate whether the function does certain things or not. If THIS happens, do THIS. Otherwise, do THIS. They make functions able to have multiple different outcomes depending on what it is that they're acting on.
//
// ****
