...
//
// Your Answer Goes Here: A block of code designed to perform a specific task. You must "call" the function.
// To define a function: function functionName() { }
//
// What is a return value?
//
// Your Answer Goes Here: Perform the function, and "return" the answer (or whatever you tell it to return, depending on your instructions).
//
//
// How do you define a named function?
//
// Your Answer Goes Here: function functionName().
//
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here: A parameter gives a "from this to this point". An argument is a statement, with a specific point.
//
// ****
...
//
// Your Answer Goes Here: Conditionals are if statetments. If (this), then (do this). They are cool.
//
//
//
