...
function addThree(number1, number2, number3)
  {
    var firstAdd = add(number1, number2);

    return firstAdd + number3;
  }
...
//A function is code that takes one or more arguments and returns a new value
//based on what the function is set up to do. The way you define a function is
//by stating 'function_space_nameoffunction(argument1, argument2)'
//Following this code you can add if statements and conditionals.
//
// What is a return value?
//
// Your Answer Goes Here:
//A return value is what the function outputs at the end of a function.
//
// How do you define a named function?
//
// Your Answer Goes Here:  A named function is one action you want your code to
// do. You name the function whatever you like and then you name two parameters and
// tell the fuction what to do with those parameters.
//
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here:
//A parameter is a data point or possibly user input that your function will
// change in some way.  An argument is the actual value that gets passed to the
...
//
// Your Answer Goes Here: They turn raw user data into what the programmer
//thinks the user is wanting to do based on the program that the programmer
//has set up.
// ****
