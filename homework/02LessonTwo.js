...
//
// Your Answer Goes Here: A function is a set of statements that performs a task or calculates a value. 
//
//
// What is a return value?
//
// Your Answer Goes Here: The return statement stops the execution of a function and returns a value from that function.
//
//
// How do you define a named function?
//
// Your Answer Goes Here: A named function is a function declaration if it appears as a statement.
//
//
// What is a parameter? What is an argument? Is there a difference between the two?
//
// Your Answer Goes Here: An argument in context with functions is the actual value that is passed to the function
//( as input) ,when it is called. However parameter refers to the variables that are used in the function declaration/definition
//to represent those arguments that were send to the function during the function call.
//
// ****
