...
function addThree(number1, number2, number3) {
  return number3 + add(number1,number2);
}
...
// Function is a JavaScript method that takes some parameters and execute a (series of) commands to obtain certain goal(s)
// Your Answer Goes Here:
//
//
// What is a return value?
// Return value is the value that is given out from executing a function
// Your Answer Goes Here:
//
//
...
// 
// Your Answer Goes Here:
//parameter is the value that is passed into a function as a given variable. Argument is basically a statement that runs something or used in conditional statements. Parameters don't do anything, but arguments execute commands
// ****
...
//
// Your Answer Goes Here:
// Conditional is like a true/false test given certain arguments. If an argument is valid, then the conditional will do something and vice versa.
//
// ****
