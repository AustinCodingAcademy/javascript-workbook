...
//
// Your Answer Goes Here: A parameter is the variable which is part of the method’s signature (method declaration). An argument is an expression used when calling the method. A
//
// ****
...
//
// Your Answer Goes Here: Conditionals are used to perform different actions based on different conditions. The ones we have practiced so far include if, else, and else if. 
