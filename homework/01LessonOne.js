...
//
// Your Answer Goes Here: "and" creats more condtions while "or" creats a one or the other, a yes or not. "and" can be used to make thing more specific while "or" is more conditional.
//
// ****
...
//
// Your Answer Goes Here: Truthiness is closer to true that some is there or exsits and is anything not false. falsie is close to false and if nothing is there or anything not true.
//
// ****
...
//
// Your Answer Goes Here: == is if values are equal or able to be equal. === is if values are equal and of the same data type.
//
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here: != is if values are true or false or can be made so. !== is if values must be true or false and of the same data type.
//
// ****
