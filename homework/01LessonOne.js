...
// Null is an assignment value, this is used when you want a variable to exsist BUT do not want it to have a value. Undefined refers to a variable that is declared but nothing has been assigned to that variable.
...
//
// Your Answer Goes Here: And tests whether the value on the left is true, and if so, test whether the item on the right is true. If both are true, then it will return true, if either one is false, it will return false. Or will test whether each item on either side is true and if at least one side is true, it will reason both together as true. You use AND OR operators in comparative statements to return a boolean.
//
// ****
...
//
// Your Answer Goes Here:Emotionally positive values are considered truthy while emotionally negative values are considered falsey. Falsey is not assigned a value while truthy variable have values assigned. Truthy is a string for example 'goodnight' Falsey is a value such as null.
//
// ****
...
//
// Your Answer Goes Here: === is an exact match, == is an approximate match.
//
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here: != is equvilant to not equal, while !== is equvilant to not approximate match.
//
// ****
