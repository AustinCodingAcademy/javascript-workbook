...
//
// Your Answer Goes Here: the AND operator needs all conditions to be true to return true, else it returns false.  the OR operator needs all conditions to be false to return false, else it returns true  
//
// ****
...
//
// Your Answer Goes Here: == converts a string to a number (if applicable) and the compares.  === only accepts a number to compare before it evaluates.
//
//
// What’s the difference between != and !==? 
//
// Your Answer Goes Here: != converts a string to a number (if applicable) and then checks for inequality.  !== checks for inequality for numbers only
//
// ****
