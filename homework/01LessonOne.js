...
//
// Your Answer Goes Here:
//truthiness is values that are "truthy" like numbers, strings, true
//falsiness is when the values are  0, null, undefined and " "
// ****
...
//
// Your Answer Goes Here:
//    == will check to see if both types are the same value, and will return true if both values are equal
//    === will check to see if both types are the same value and type, if they are different values or different types, it will evaluate to false
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
