...
//
// Your Answer Goes Here: and means both have to be true otherwise ti is false and or means either can be true and it is true.
//
// ****
...
//
// Your Answer Goes Here: anything that evaulates to true or an actual value evaluates to true and false is the opposite except in the area of numbers if it evaulates to 0 it is also false.
//
// ****
...
//
// Your Answer Goes Here: essentailly === has to match perfectly and == attempts to understand what you are looking for and can take something from a string such as '4' == 4 and evalutae it to true
//
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here: opposite of the last question
//
// ****
