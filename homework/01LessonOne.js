...
// null has a value of null whereas something is undefined if it has no value
...
//and is used when you need both conditions to be true. or is used when you need at least one of the conditions to be true
// ****
...
//
// Your Answer Goes Here:
//Something is considered truthy when it is considered to be true and trutiness is the extent of its truth
// i.e.  '4' = 4 is true  but '4' === 4 is false because they are not of true to the same extent
//
//
//****
...
//
// Your Answer Goes Here:
//== means equals to, and === means equals to and must be of the same type
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
//!= means not equal to, and !== means not equal to and not of the same type
// ****
