...
// For 'and', both operands have to be true for the operation to be true; for 'or', at least one operand has to be true for the operation to be true
// You would use 'and' if you want multiple conditions to be true; you would use 'or' if you want at least one of multiple conditions to be true 
// ****
...
//
// Your Answer Goes Here:
// Truthiness evaluates to Boolean 'true' while falsiness evaluates to Boolean 'false'
// ****
...
//
// Your Answer Goes Here:
// == checks for the same value only while === checks for the same value and type
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
// != checks for different values while !== checks for different values or types
// ****
