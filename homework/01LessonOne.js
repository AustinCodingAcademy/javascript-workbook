...
//
// Your Answer Goes Here: It compares and returns true or false. AND" will test weather the value to its left and right is true if so then it'll test the one on the right, if both are false
...
//
// Your Answer Goes Here:Truthiness is when something has a positive value, for example strings and numbers are truthy.
// Whereas falsiness is when something has a negative value, for examples 0, false, null are falsey
// ****
...
//
// Your Answer Goes Here: The two equal to signs means "equal to" and three equal to signs means they are equal value. For example, if variable x=3, then x=="3";but while x==="3" is false.
//
//
// What’s the difference between != and !==?
//
