...
// Null is a value given as a placeholder. Undefined means a variable has been declared, but nothing has been assigned.
...
//
// Your Answer Goes Here: In order for "and" statements to be true, both statements have to be true. In order for "or" statements to be true, only one of the statements have to be true.
//
// ****
...
//
// Your Answer Goes Here: It is truthy if it has an "emotionally positive" value. It is falsey if it is assigned an "emotionally negative" value or no value at all.
//
// ****
...
//
// Your Answer Goes Here: == only compares values. === compares value and type.
//
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here: != returns the opposite truthiness value when only the value is factored in. !== returns the opposite value when value and type are factored in.
//
// ****
