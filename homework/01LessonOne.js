...
// My Answer: an undefined variable has no value or has not been assigned a value, null is an empty value.
...
// AND (&&) will test the value on the left and right side for a true value if either side contains false it will return false. OR (||) will test the value on either side is true and if either or both are true it will return true. They are logical operators used to determine the logic between variables or values.
// ****
...
//
// Your Answer Goes Here:
// == means equal to === means equal value and equal type.
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
// != not equal to and !== means not equal value or not equal type.
// ****
