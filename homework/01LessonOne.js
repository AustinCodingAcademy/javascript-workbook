...
//null is a special object and undefined means the variable has not been defined.
...
//
// Your Answer Goes Here: the "and" operator tests the left then the right and if they are both true it returns true if not it tests false.  The "or" tests the left then the right looking to see whetehr or not one is true.  If one is true it will return true. You would use the "and" when you need to come up with a true staement you would use the "or" if you are looking to see if one is true and not necessarily both need to be true.
//
// ****
...
//
// Your Answer Goes Here: Truthiness is an emotionally positive value.  An example would be true, any integer other than 0.  Falsiness is an emotionally negative value.  Examples of this would be null, undefined, NaN.
//
// ****
...
//
// Your Answer Goes Here: == tests the two sides based on permissive value equality between two variables after trying to parse them.  === is a less permissiive value it checks value and type equality. this is the recommended way to test for equality and is much safer.
//
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here: != tests the two sides based on permissive value equality between two variables after trying to parse them but the difference is not equal.  !== is a less permissiive value it checks value and type equality but the difference is not equal. this is the recommended way to test for equality and is much safer.
//
// ****
