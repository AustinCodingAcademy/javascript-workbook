...
//
// Your Answer Goes Here: AND (&&) operators are true if everything in the parentheses are true. OR (||) operators will be true if anything in the parentheses are true. Word up.
//
// ****
...
//
// Your Answer Goes Here: I don't know what you mean by "emotionally negative" or "emotionally positive"... but from what I can tell, things are truthy when they have a value (any number, true, a string, etc.). Things are falsey when they either are undefined are assigned to have nothing as their value (null, 0, undefined, etc.)
//
// ****
...
//
// Your Answer Goes Here:== isn't as strict. it will try to convet both sides to the same type. === is strict, and will not convert anything before comparing.
//
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here: Same concept as above.  != (not equal to) is less strict than !==. For example, if x=2, x != '2' would be true, while x !== '2' is false. Right?
//
// ****
