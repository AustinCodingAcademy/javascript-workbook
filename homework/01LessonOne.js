...
// Problem 16:
// What is the value of !!true
// I assume !! means not-not so true??
...
// "and" returns the value on the left while "or" returns the one of the right. You would use each depending on which variable you need to compare. 
...
//
// Your Answer Goes Here:
// truthiness simply means the variable has a value, i.e. var name = 'bob' is truthy while and undefined, null, or 0 variable is falsey, i.e. var name = null
// ****
...
//if this were === it would be false
// or in strict its probably false???
...
//
// Your Answer Goes Here:
// == checks to see if the values are equal to one another but === checks to see if they are exactly equal, and the computer will not try to change a string, '4' to 4...
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
// != is not not equal to and !=== is not exactly equal to. 
// ****
