...
// Null is a place holder with no value and undefined is stating that nothing is defined
...
// "and" means you need both condition to be true to get a true output and also both to be false to get a false output. "Or" means either or can be true in order to get a true or false output.
//
// ****
...
// Truthiness is anything that outputs the value of true like 3 ===3 this would equal true. Falseiness
// is anything that would give a false value. Also Null values NAN and undefined
// Your Answer Goes Here:
//
// ****
...
//
// Your Answer Goes Here:
// "==" means not equal to in value. "===" means it has to be equal to in value and also in type.
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
//"!=" means not equal to in value. "!==" means not equal to in value or type.
// ****
