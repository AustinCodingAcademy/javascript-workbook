...
//
// Your Answer Goes Here: "and" operators check if the value on the left is true and if it is, it will check if the value on the right is true. If both are true, then it with return 'true'.
//
// ****
