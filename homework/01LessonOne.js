...
//
// Your Answer Goes Here: The "and" operator will result in TRUE, only if both values are TRUE. The "or" operator will only result in TRUE when both operators are TURE.
//
// ****
