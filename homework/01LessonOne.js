...
//
// Your Answer Goes Here: AND tests whether the value on the left is true, and if so, test whether the item on the right is true. If both are true, then it will return true, if either one is false, it will return false. OR tests whether each item on either side is true and if at least one side is true, it will reason both together as true.
//
// ****
...
//
// Your Answer Goes Here: Falsey are values that are undefined, null, NaN, 0, "" (empty string), and false. Everything else is truthy.
//
// ****
...
//
// Your Answer Goes Here: Using == you check if something is equal to something else (not strict).
// Using === you check if something is equal to something else (strict). What strict does, in case it wasn't clear there, is that it checks not only the equality of the two values, it compares the types of the two values too.
//
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here: != means not equal, whereas !== means non-identity
//
// ****
