...
// null creates a variable, uundefined means the variable does not exist
...
//
// and must evaluate all arguments as true to return true, or just needs to evaluate one argument as true before returning true.
...
//
// Your Answer Goes Here:
//truthiness is a set of values that will default to true when placed in a boolean context, falsiness is a set of values that will default to false when placed in a boolean context.
// ****
...
//
// Your Answer Goes Here:
//=== requires that the type be the same to evaluate as true, == means the value to has to be the same, but the types can be different. 
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
// !== considers the type as well as the value
// ****
