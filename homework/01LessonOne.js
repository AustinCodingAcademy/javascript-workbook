...
var myNull = null;
//Undefineds means a variable has been created but no value has been assigned
//Null means that a value has been assigned but is equal to no value
...
//
// Your Answer Goes Here:
//In JavaScript, a truthy value is a value that translates to true when evaluated in a Boolean context. A falsy value is a value that translates to false when evaluated in a Boolean context.
// ****
...
//
// Your Answer Goes Here:
//By using == you check if something is equal to something else. This is not strict. By using === you check if something is equal to something else. This is also strict
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
//!== and === are strict comparison, and == / != are loose comparison.
// ****
