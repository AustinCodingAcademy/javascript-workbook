...
// You would use "and" operator to verify if all clause are true to continue.
// You would use "or" operator to verify at least one of the clauses are trye to pass.
// ****
...
// Your Answer Goes Here:
// truthiness is something that I felt to be true, even if not necessarily true
// falsiness is something that I felt to be false, even if not necessarily false
// ****
...
//
// Your Answer Goes Here:
// == compare if they have eaual value
// === compare if they have equal value and equal type
//
// What’s the difference between != and !==?
//
//
// Your Answer Goes Here:
// != this compare if they have not equal value
