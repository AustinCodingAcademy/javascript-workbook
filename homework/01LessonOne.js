...
// ANSWER: undefined means a variable has been declared but has not yet been assigned a value. On the other hand, null is an assignment value. It can be assigned to a variable as a representation of no value.
...
// Logical operations like "and" (&&) and "or" (||) are used to determine the logic between variables and values. This will coerce the variable and it's value into a boolean value. You would use && when trying to determine if two different statements are together are true, where as you'd use || when trying to determine if at least one of the statements is true.
// ****
...
//
// Your Answer Goes Here:
// Truthy means that a value coerces to true when evaluated in boolean context, while falsy eans that a value coerces to false when evaluated in boolean context.
// ****
...
//
// Your Answer Goes Here:
// By using == you check if something is equal to something else. This is not strict. By using === you check if something is equal to something else. This is also strict.  Strict checks not only the equality of the two values, it compares the data types of the two values too.
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
// By using != you check if something is not equal to something else. This is not strict. By using !== you check if something is equal to something else. This is also strict.  Strict checks not only the inequality of the two values, it compares the data types of the two values too.
// ****
