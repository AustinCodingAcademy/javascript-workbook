...
//
// What is the difference between null and undefined? 'null' is used when a variable is being defined, but has no meaningful value. 'undefined' is a value that is returned when the variable has no assignment, not even 'null'.
...
//
// Your Answer Goes Here: "and" operators check if the value on the left is true and if it is, it will check if the value on the right is true. If both are true, then it with return 'true'. "or" operators check if the left value is true and if it is it will return 'true'. If the left value is false, but the right value is true then it will return 'true'. If the left and right values are false than an "or" operator will return 'false'.
//
// ****
...
//
// Your Answer Goes Here: A value is truthy if it is "emotionally positive" and actually exists. True, strings, and numbers (except for 0) are all truthy. A value is falsey if it is "emotionally negative" or does not have a value. False, 0, and null are all falsey.
//
// ****
...
//
// Your Answer Goes Here: == is used to say that these two values are equal but different data types. === is used to show that these two values are equal and the same datatypes.
//
//
// What’s the difference between != and !==? != means that these are not equal. !== means that these are not equal and are not the same datatype.
//
