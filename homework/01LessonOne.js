...
//
// Your Answer Goes Here: "and" is used to evaluate if both statements are true while "or" is to evaluate if one or both expressions are true
//
// ****
...
//
// Your Answer Goes Here: truthiness is a value that translates to true when evaluated in a Boolean context. All values are truthy unless they are defined as falsy (i.e., except for false, 0, "", null, undefined, and NaN).
//if(true), if(false)
// ****
...
//
// Your Answer Goes Here: The equality operator (==) converts the operands if they are not of the same type, then applies strict comparison. The identity operator returns true if the operands are strictly equal (see above) with no type conversion
//
// What’s the difference between != and !==?
//
