...
// Answer: null is a deliberate absence of value.
...
//
// Your Answer Goes Here: An expression with "and" operator evaluates true only if both operands are true. An expression with "or" operator evaluates false only if both operands are false. "and" operator can make a condition more specific, while an "or" operator can make it more broad.
//
// ****
...
//
// Your Answer Goes Here: Truthiness means there's something there. 1 'hi' true are examples of truthy values. Falsiness means there isn't anything there. 0 '' false null are examples of falsy values.
//
// ****
...
//
// Your Answer Goes Here: == checks whether values are equal or can be made equal. === checks whether values are equal and of the same data type (strict equality)
//
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here: same as double or triple equal signs, but with 'true' and 'false' values switched.
//
// ****
