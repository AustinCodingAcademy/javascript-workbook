...
// null is used to assign a 'no value' value to a declared variable.
...
// The && (and) operator results in a true value only if both variables in the argument are true.
// The || (or) operator results in a true value if only one of the variables in the argument are true.
// I would use both of these operators in cases where i would need to determine if both variables are true, or only one is.
// In some cases both variables would need to be true in order for the program to complete.
// In other cases, only one variable would need to be true for the program to progress.
//
// ****
...
// Your Answer Goes Here:
// 
// truthy means that when evaluated in a boolean context the result is true.
// '4' === 4
//
//falsy means that when evaluated in a boolean context the result is false.
// 'test' = 0
//
//
// ****
...
//
// Your Answer Goes Here:
// == is equality with type coersion
// === is equality without type coersion
// 
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
//
// != means not equal with type coersion
// !== means not equal without type coersion
// 
// ****
