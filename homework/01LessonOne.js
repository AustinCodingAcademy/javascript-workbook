...
//null defines the variable as nothing, undefined means no value asssigned
var myNull = null;
...
//
// Your Answer Goes Here:
// if the variable exists and has a value of at least not "0" it is truthy. if the var does not exist or defined as null, 0 or flase it is falsey.
// ****
...
//
// Your Answer Goes Here:
// == compares values only whereas === compares the data type and value
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
//!= means not equal and !== compares data type and if not equal
// ****
