...
//
// Your Answer Goes Here: "and" selects true if both variable are true. "or" selects true if either variable is true.
//
// ****
...
//
// Your Answer Goes Here: "truthiness" means they variable in generally thought to be true. "falsiness" means the opposite.
//
// ****
...
//
// Your Answer Goes Here: "==" checks if the variable are equal. "===" checks if the variables and types are equal.
//
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:"!=" checks if the variables are not equal. "!==" checks if the variables and the types are not equal.
//
// ****
