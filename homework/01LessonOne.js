...
//null assigns a value that represents nothing, but undefined means no value has been assigned.
...
//"and" checks for both arguments to be true, "or" checks for at least one argument being true.
//"and" should be used when two things need to be true together, "or" should be used when one or more thing needs to be true but it doesn't matter which one
// ****
...
//
// Your Answer Goes Here:
//truthiness refers to a value that exists and evaluates to true, such as a number (3) or a string ("hello").
//Falsiness refers to something that does not exist and evaluates to false, such as null, 0, or undefined.
// ****
...
//
// Your Answer Goes Here:
//== checks that two values are equivalent. === is a stricter check that needs the two arguments to have equal value and the same type
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
////!= evaluates to true if the two arguments differ in value, !== evaluates to true if the two arguments differ in value or in type
// ****
