...
// *And* will test whether the value on the left is true, and if it is, it will test whether the right is true. If both are true, it will return true. If one is false, it will return false. *Or* will test whether at least one value on either side is true. If so, it will return true.
// ****
...
//
// Your Answer Goes Here:
//If something has an "emotionally positive" value, it is considered Truthy. These include true, "hello" 4, -5, etc. If something has an "emotionally negative" value, it's falsy. These include false, null, undefined, and 0.
// ****
...
//
// Your Answer Goes Here:
//== and === do similar jobs except === does not automatically convert the items on either. If both items are not of the same type, it will return "false". For example, "3" == 3 is true, "3" === 3 is false.
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
//Similarly to the above, != and !== do the same job except != auto converts the type, and !== doesn't. The addition of the ! at the beginning is "bang" which is the same as saying "not", so "!==" means "not equal"
// ****
