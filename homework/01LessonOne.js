...
// undefined means that the variable has not been declared, or has not been given a value. null is a special object because typeof null returns 'object'. The value of a variable with no value is undefined
var myUndefined;
...
//And means both must be equal to each other and or means the first one has to be true
// ****
...
//
// Your Answer Goes Here:
//a truthy value is a value that translates to true when evaluated in a Boolean context. All values are truthy unless they are defined. its all truthy unless it is defined as falsey
// ****
