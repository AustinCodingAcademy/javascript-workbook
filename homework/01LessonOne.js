...
//
// Your Answer Goes Here: The "and" operator is used when you want to return true only if everything your are comparing is true.
// The "or" operator is used when you want to return true if any of your comparables are true.
//
// ****
...
//
// Your Answer Goes Here: truthiness is an affirmation of something, such as "1 === 1".
// falsiness is the confirmation that something is not true, such as "1 === 2"
// ****
...
//
// Your Answer Goes Here: '==' is a comparison operator and '===' is a strict
// comparison operator. The == operator will compare the values of strings to
// numbers and the strict comparison operator will not.
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here: "!=" is a not equals comparison operator and
// '!==' is a strict not equals comparison operator that compares the falsiness
// similar to the way === compares the strict truthiness.
// ****
