...
// Null is an intentional undefined while undefined isn't.
...
// "and" operators mean that both expressions on either side of them have to be true in order for the whole thing to be true. "or" operators mean that only one expression has to be true in order for the whole thing to be true.
// ****
...
//
// Your Answer Goes Here:
// truthiness is anything that has a value. falsiness is anything that doesnt have a value and zero.
// ****
...
//
// Your Answer Goes Here:
// '==' means it will try and change one side to equal the other side. '===' means that they have to be equal vaules and types.
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
// '!=' means that both values are not equal. '!==' means that both the values and types are not equal.
// ****
