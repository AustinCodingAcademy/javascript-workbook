...
// UNDEFINED MEANS THAT THE SCRIPT KNOWS OF THE VARIABLE'S EXISTENCE BUT IT HAS NOT YET BEEN GIVEN A VALUE, AND NULL IS AN EMPTY VALUE OF A VARIABLE.
var myNull = null;
...
//'AND' LOOKS FOR BOTH OF THE OPERANDS TO BE TRUE IN ORDER TO RETURN A TRUE VALUE, WHERE 'OR' CHECKS FOR ONLY ONE OPERAND TO BE TRUE IN ORDER FOR THE EXPRESSION TO BE TRUE. WHEN YOU NEED A VALUE TO BE EXPLICITLY TRUE, YOU WOULD USE THE '&&' OPERATOR. IF YOU ARE ONLY LOOKING FOR A PARTIAL TRUE VALUE, THEN THE '||' WILL SUFFICE.
// ****
...
//
// Your Answer Goes Here:
//TRUTHINESS / FALSINESS IS A SYSTEM OF VALUE TRANSLATION WHERE ANY VALUE CAN BE DEFINED AS TRUE OR FALSE.
//TRUTHY = NON-ZERO NUMBERS, BOOLEAN TRUE, 'STRINGS'
//FALSY = ZERO, BOOLEAN FALSE, NULL/UND
// ****
...
//
// Your Answer Goes Here:
//  EQUAL TO(==) COMPARES TWO VALUES, BUT STRICTLY EQUAL TO (===) COMPARES THE VALUES AS WELL AS THEIR DATA TYPES.
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
////  NOT EQUAL TO (!=) COMPARES TWO VALUES, BUT STRICTLY NOT EQUAL TO (!==) COMPARES THE VALUES AS WELL AS THEIR DATA TYPES.
// ****
