...
// A: 'null' is a placeholder value that is assigned to a variable. 'undefined' means no value has been applied.
...
var myString = "Woooooo Javascript!";
...
//
// Your Answer Goes Here: "and" is more strict and is used when all variables need to be "true". The "or" operator is more flexible.
//
// ****
...
//
// Your Answer Goes Here: Truthiness/falsiness is a "positive" or "negative" trait
//ex. "string" = truthy, null = falsey
// ****
...
//
// Your Answer Goes Here: "==" is a type-converting comparison, whereas "===" is a strict comparison. When using a strict comparison,
// the two values must be a perfect match in every way.
//
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here: "!=" is a type-converting comparison, and "!==" is a strict comparison.
//
// ****
