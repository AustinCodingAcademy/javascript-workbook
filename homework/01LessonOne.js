...
// undeclared is a variable that has been declared but has not been assigned anything yet; a null is just an object.
...
// "and" literally means that both clauses should be true to make the statement true; "or" means that if either of the clause is true, then the statement is true and vice versa 
// ****
...
// 
// Your Answer Goes Here:
// True value are those who are considered true in the boolean context, like a string or number; false values are the exact opposite - those considered false in boolean, like null.
// ****
...
//
// Your Answer Goes Here:
// Double equal refer to those who have the same value; triple equal refer to those with same value and type. 
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
// Similarly, "!=" just considers the value but not the type, whereas "!==" take both into account. 
// ****
