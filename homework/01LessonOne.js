...
//
// With and both conditions must be true to return a true. Or statements only one condition must be met to return true.
...
// Your Answer Goes Here:
//
// When the program expexts a boolean it evaluates the information to see if it comes back true or false. certain things are always false ex. 0 
...
//
// Your Answer Goes Here:
//== will do type conversions === has to be the exact same
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
//
// !== is a strict comparison != will convert types
