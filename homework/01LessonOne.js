...
// Null is an object that is empty and does not have a value.
// Undefined meanes the variable has not been declared or given a value.
...
// The "and" operator returns true if both variables are true, otherwise it returns false.  The "or" operator returns true if one or both variables are true, otherwise it returns false.
// I would use "and" or "or" to compare two values or variables.
// ****
...
//
// Your Answer Goes Here:
// Truthiness is when something evaluates to true, and falsiness is when something evaluates to false.  An example of true would be 17, and an example of false would be null.
// ****
...
//
// Your Answer Goes Here:
// == is equal to, and === is equal to, and equal type, meaning variables need to also be the same type in order to evaluate to true.
//

// What’s the difference between != and !==?
//
// Your Answer Goes Here:
// != is not equal to, and !== is not equal to, and not equal type, meaning variables need to be not equal and also not be the same type in order to evaluate to true.
