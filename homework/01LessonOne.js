...
// null is an assigment value, while undefined means a variable has been declared, but nothing has been assigned. 
...
//
// Your Answer Goes Here:  The "and" logical operator states that conditions are true (ex. If you have an expression that needs two conditions to be met you would use the "and" operator). The "or" operator states that one of the conditions has to be true. (ex. If you have an expression that needs one of the conditions to be met you would use the "or" logical operator).
//
// ****
...
//
// Your Answer Goes Here:  Truthiness and falsiness are a set of vaules that can evaluate to true or false but may not equal true or false. Truthy values are true, non-zero numbers, strings, objects, arrays, and functions. Falsy values are false, 0, empty strings, undefined, null, NaN.
//
// ****
...
//
// Your Answer Goes Here: the == is a comparison operator is just checking for the value and the ==== comparison operator checks for value and type.
//
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here: the != is saying the value is not equal and the !== is saying the value and type.
//
// ****
