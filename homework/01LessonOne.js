...
// Undefined means that a value has not been assigned to a variable, but the variable has been declared.
// Null is a representtion of no value, and it can be assigned to a variable.
...
// "And" means that both expressions on each side of a comparison need to happen. 
// "Or" means that either or of the expressions on each side of a comparison need to happen.
//
// ****
// ****
// Truthiness
...
//
// Your Answer Goes Here:
// Truthiness is how true a statement is, falsiness is how false a statement is.
// For example 4 == 2; is false
...
//
// Your Answer Goes Here: 
// == will try to make both sides equal to each other as long as the value is the same. So '3' == 3 is true.
// === checks for the type and the value. So '3' === 3 is false, since one is a string and the other a number.
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here:
// Same as the above. != will check for only value, !== will check for type and value.
//
// ****
