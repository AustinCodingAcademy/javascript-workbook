...
//
// Your Answer Goes Here: == checks for equality of the output. === checks the equality of the output and the type. Will only return true if the type of output is the same output and type of the item it is being compared to
//
//
// What’s the difference between != and !==?
//
// Your Answer Goes Here: != means not equal in value. !== means not equal in value or type
//
// ****
