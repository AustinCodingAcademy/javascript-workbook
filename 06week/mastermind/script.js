...
document.addEventListener('DOMContentLoaded', () => {
  ...
  var MasterMind = (function () {
    ...
    function submitGuess (guess) {
      ...
      var remainingTurns = maxTurns - guesses.length;
  ...
  var Game = (function () {
    ...
    function _processGuess (guess) {
      ...
      var statusEl = lineEl.querySelector('.mm-status');
    ...
    function _displaySolution (solution) {
      ...
      var slots = solEl.querySelectorAll('.mm-slot');
    ...
    function submitMove (color) {
      ...
      var lineEl = lineEls[currentLine];
      var slotEl = lineEl.querySelector('[data-slot="' + currentSlot + '"]');
