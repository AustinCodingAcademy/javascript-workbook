...
const stringsToNumbs = (numbers) => 
  ...
  const digitsArr = stringsToNumbs(strNums);
...
const weatherStates = arr => {
  const weatherNames = arr.map(name => name.weather_state_name)
  const unique = (value, index, self) => {
    // console.log("value:", value)
    // console.log("index:", index)
    // console.log("self:", self.indexOf(value))
