...
console.log(
  `"Austin" value is: index: ${atxIdx}, value: ${
    nums[atxIdx]
  }, total(index + value): ${atxIdx + nums[atxIdx]}`
);
...
// const weatherStates = weather.filter(
//   (stateName, i, arr) => arr.indexOf(stateName) === i
// );

// const weatherStates = [weather].filter((x, i, a) => a.indexOf(x) === i);

// const weatherStates = [
//   weather[0].weather_state_name,
//   weather[1].weather_state_name
// ];

// const weatherStates = weather
//   .filter(function(weatherState, i, ar) {
//     return ar.indexOf(weatherState.weather_state_name) == i;
//   })
//   .map(function(weatherState) {
...
console.log("****** Unique weather states array below ******");

console.log(weatherStates); // logs the weather object from weatherStates variable

// //find the id of the object in weather that has a min_temp of 15.915
// find() will return the value of the first element inthe array that satisfies the testing function
const minTemp = weather.find(item => item.min_temp === 15.915);
// use dot notation to access the property and save in variable
const idealTemp = minTemp.id;

// console.log(`logging ("weather[3].id") = ${weather[3].id}`);
// console.log(`logging ("id" in minTemp) = ${"id" in minTemp}`);
console.log(
  `id of the object in weather that has a min_temp of 15.915: = ${idealTemp}`
);
