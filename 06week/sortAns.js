...
let sumzzz = sumEvens(stringsToNumbs(strNums))
console.log("Sum of the even values: ",sumzzz);
console.log("////////////////////////////////////////////////////////")
...
//'weather_state_name' values of the weather array. Your function should 
//return the following array ['Light Cloud', 'Heavy Cloud', 'Showers']
const weatherStates = (weather) => {
  let arr = []
  weather.forEach((item) => {
    if(arr.lastIndexOf(item.weather_state_name) === -1){
      arr.push(item.weather_state_name)
    }
  })
  return arr;
}
console.log("WEATHER STATES: ",weatherStates(weather))
console.log("////////////////////////////////////////////////////////")
...
console.log("ID of the object in weather: ",idealTemp(weather))