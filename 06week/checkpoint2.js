...
const mainArray = weather.map(item => {
  return item["weather_state_name"];
});

const weatherStates = mainArray.filter(function(item, index, self) {
...
const idealTemp = weather.find(newItem => {
  return newItem["min_temp"] === 15.915;
});
