...
const evenSum = nums.reduce((acc, num) => {
  if (num % 2 === 0) {
    acc += num;
  }
  return acc;
}, 0);
console.log("__ SUM OF EVENS ____________");
console.log(evenSum);

// Find the index of the first "Austin" value (the value plus its index equals 512)
const atxIdx = nums.findIndex((val, i) => val + i === 512);
console.log("__ AUSTIN VALUE _____________");
...
console.log("__ Weather States ___________");
...
console.log("__ id heavy cloud ____________");
