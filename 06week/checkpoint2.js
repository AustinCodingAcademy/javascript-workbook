...
const Evens = nums.filter((curr, i, arr) => {
  return curr % 2 === 0;
});
const sumEvens = Evens.reduce((prev, curr) => {
  return prev + curr;
});
console.log(sumEvens);

// Find the index of the first "Austin" value (the value plus its index equals 512)
const atxIdx = nums.findIndex((curr, i, arr) => {
  return curr + i === 512;
});
...
const idealTemp =
  weather[
    weather.findIndex(curr => {
      return curr.min_temp === 15.915;
    })
  ].id;
