...
const sumOfTwoNumbers = (num1, num2) =>{
  ...
  if(typeof numberConvert1 == "number" && typeof numberConvert1 == "number" && !Number.isNaN(numberConvert1) && !Number.isNaN(numberConvert2)){
  //yikes, but the logic is just convert the numbers that might be strings to numbers and if the aren numbers and don't turn into NaNs because of he conversion, then go ahead and add them.
    return numberConvert1 + numberConvert2;

  }
  return "Not valid number or string numbers"
}
